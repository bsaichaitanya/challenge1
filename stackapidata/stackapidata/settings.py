"""
Django settings for stackapidata project.
...
SECRET_KEY = '@71d7ievkc7^qg++gh9prkms+$%f)_or-_g605g+h@6jn2f3(m'
...
ROOT_URLCONF = 'stackapidata.urls'
...
WSGI_APPLICATION = 'stackapidata.wsgi.application'
